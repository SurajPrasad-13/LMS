...
const Courses = () => {
  ...
  const courses = [
    {
      ...
      description: "Master AI and ML from scratch with hands-on projects using Python, TensorFlow, and real-world datasets.",
    ...
    },
    {
      ...
      price: 99,
      image: "/api/placeholder/400/225",
      description: "Build modern web applications with React, Next.js, and TypeScript. Includes state management and testing.",
    ...
    },
    {
      ...
      price: 79,
      image: "/api/placeholder/400/225",
      description: "Learn design thinking, user research, wireframing, and prototyping using Figma and Adobe XD.",
    ...
    },
    {
      ...
      price: 129,
      image: "/api/placeholder/400/225",
      description: "Comprehensive data science program covering statistics, visualization, and machine learning algorithms.",
      skills: ["Python", "R", "Statistics", "Visualization"],
      features: ["Real Projects", "Certificate", "Career Guidance", "Tools Access"]
    },
    {
      id: 5,
    ...
    },
    {
      ...
      price: 119,
      image: "/api/placeholder/400/225",
      description: "Build professional iOS apps using Swift and SwiftUI. From basics to App Store deployment.",
      skills: ["Swift", "SwiftUI", "Xcode", "App Store"],
      features: ["App Development", "Certificate", "Deployment Guide", "Review"]
    }
  ];
  ...
  const featuredCourse = {
    ...
    originalPrice: 299,
    salePrice: 199,
    description: "The most comprehensive course combining AI, web development, and cloud technologies. Build 12 real-world projects.",
    highlights: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-12 opacity-90 leading-relaxed">
              Join thousands of students learning in-demand skills with our AI-personalized 
              curriculum and industry expert instructors.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredCourses.map((course) => (
                <Card key={course.id} className="interactive-card group border-0 shadow-lg overflow-hidden">
      ...
      <section className="py-24 bg-gradient-to-r from-primary to-secondary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Our AI-powered learning paths can create a custom curriculum just for you. 
            Tell us your goals and we'll design the perfect learning journey.
          </p>
