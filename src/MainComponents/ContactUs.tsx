        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-12 opacity-90 leading-relaxed">
              Have questions about our courses, need technical support, or want to discuss 
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Visit us at one of our offices worldwide or connect with our local teams 
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90 leading-relaxed">
              Our support team is standing by to help you succeed. Whether you need 
              technical assistance, have billing questions, or want to learn more 
              about our programs, we're here for you.
            </p>
