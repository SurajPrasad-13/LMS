        ...
        { !user && showFormModal && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.4 }}
              className="bg-gradient-to-br from-orange-200 to-white rounded-lg shadow-lg py-2 px-6 w-[calc(100%-3rem)] sm:w-1/2 md:w-[65vw] lg:w-1/2 max-h-[85vh] overflow-y-scroll [&::-webkit-scrollbar]:hidden relative"
            >
              <button
