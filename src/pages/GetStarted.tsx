      ...
      <div className="flex-1 flex items-center justify-center p-4  md:p-8 bg-background">
        <Card className="w-full max-w-md interactive-card">
          <CardHeader className="text-center">
            <div className=" size-12 md:size-16 mx-auto md:mb-4 rounded-full bg-gradient-learning flex items-center justify-center">
              <Rocket className=" md:size-8 text-white" />
            </div>
